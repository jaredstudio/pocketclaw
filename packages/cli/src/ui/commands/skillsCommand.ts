...
import { getAdminErrorMessage, getErrorMessage } from '@pocketclaw/core';
import {
  linkSkill,
...
export const skillsCommand: SlashCommand = {
  name: 'skills',
  description:
    'List, enable, disable, or reload PocketClaw agent skills. Usage: /skills [list | disable <name> | enable <name> | reload]',
