...
import { ApprovalMode } from '@pocketclaw/core/src/policy/types.js';
...
vi.mock(
  '@pocketclaw/core',
  async (
    importOriginal: () => Promise<typeof import('@pocketclaw/core')>,
  ) => {
...
describe('Session', () => {
  ...
  it('should call updatePolicy when tool permission triggers always allow', async () => {
    ...
    const { updatePolicy } = await import('@pocketclaw/core');
