...
import { debugLogger, isGitRepository } from '@pocketclaw/core';
...
export function getInstallationInfo(
  ...
  try {
    ...
    if (
      ...
      const updateCommand = 'pnpm add -g pocketclaw@latest';
      return {
    ...
    if (realPath.includes('/.yarn/global')) {
      const updateCommand = 'yarn global add pocketclaw@latest';
      return {
    ...
    if (realPath.includes('/.bun/install/global')) {
      const updateCommand = 'bun add -g pocketclaw@latest';
      return {
    ...
    // Assume global npm
    const updateCommand = 'npm install -g pocketclaw@latest';
    return {
