...
/**
 * Decoupled LLM request format - stable across PocketClaw versions
 */
...
/**
 * Decoupled LLM response format - stable across PocketClaw versions
 */
...
/**
 * Decoupled tool configuration - stable across PocketClaw versions
 */
