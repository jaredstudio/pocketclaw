          ...
          paths: [
            {
              ...
              message:
                'Please use the helpers from @pocketclaw/core instead of node:os homedir()/tmpdir() to ensure strict environment isolation.',
            },
            {
              name: 'os',
              importNames: ['homedir', 'tmpdir'],
              message:
                'Please use the helpers from @pocketclaw/core instead of os homedir()/tmpdir() to ensure strict environment isolation.',
            },
          ],
        },
      ],
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          ...
          message: 'Please use relative imports within the @pocketclaw/core package.',
        },
      ],
    },
  },
  ...
  },
  {
    ...
    rules: {
      'no-restricted-imports': [
        ...
        {
          name: '@pocketclaw/sdk',
          message: 'Please use relative imports within the @pocketclaw/sdk package.',
        },
      ],
    },
  },
